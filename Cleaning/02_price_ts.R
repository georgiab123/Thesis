...
t1 <- ts(price_data_r$us_lng_export_price, start=c(2016, 2), end=c(2022, 8), frequency=12)
t2 <- ts(price_data_r$japan_korea, start=c(2016, 2), end=c(2022, 8), frequency=12)
t3 <- ts(price_data_r$nbp, start=c(2016, 2), end=c(2022, 8), frequency=12)
t4 <- ts(price_data_r$henry_hub, start=c(2016, 2), end=c(2022, 8), frequency=12)

# the below have different start and end dates 
t5 <- ts(price_data_r$dutch_ttf, start=c(2016, 2), end=c(2022, 8), frequency=12)
...
term_ts_1 <- ts(LNG_term_prices$sabine_pass, start=c(2016, 2), end=c(2022, 8), frequency=12)
term_ts_2 <- ts(LNG_term_prices$cove_point, start=c(2016, 2), end=c(2022, 8), frequency=12)
term_ts_3 <- ts(LNG_term_prices$corpus_christi, start=c(2016, 2), end=c(2022, 8), frequency=12)
term_ts_4 <- ts(LNG_term_prices$cameron_LA, start=c(2016, 2), end=c(2022, 8), frequency=12)
term_ts_5 <- ts(LNG_term_prices$freeport, start=c(2016, 2), end=c(2022, 8), frequency=12)
term_ts_6 <- ts(LNG_term_prices$elba_island, start=c(2016, 2), end=c(2022, 8), frequency=12)
